<?php
	...
	$limit = 20;//mitu pilti ühele lehele soovin mahutada. Reaalelus oleks normaalne palju suurem number, näiteks 30 jne
	$picCount = countPics(1);//küsin kõigi näidatavate piltide arvu, et teada, palju lehekülgi üldse olla võiks. Parameetriks piltide privaatsus. Funktsioon ise näitena allpool.
	//echo $picCount;
	...
	$gallery = readAllPictureThumbsPage($privacy, $page, $limit);
?>
<!DOCTYPE html>
<html lang="et">
<head>

...
function readNews($limit)
{
    ...
    $stmt = $conn->prepare("SELECT vr20_news.id, vr20_news.userid, vr20_news.title, vr20_news.content, vr20_news.created  FROM vr20_news where deleted is null order by id desc LIMIT ?");
    echo $conn->error;
